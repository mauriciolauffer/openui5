...
sap.ui.define([
	...
	var oMockData = {
			...
			mFixture : {
				...
				"/sap/opu/odata4/sap/zui5_testv4/f4/sap/h_tcurc-sh/0001;ps='default-zui5_epm_sample-0002';va='com.sap.gateway.default.zui5_epm_sample.v0002.ET-BUSINESSPARTNER.CURRENCY_CODE'/H_TCURC_SH_Set?$select=LTEXT,WAERS&$skip=0&$top=20"
					: {source : "CurrencyList.json"},
				"/sap/opu/odata4/sap/zui5_testv4/f4/sap/d_bp_role-fv/0001;ps='default-zui5_epm_sample-0002';va='com.sap.gateway.default.zui5_epm_sample.v0002.ET-BUSINESSPARTNER.BP_ROLE'/D_BP_ROLE_FV_Set?$select=FIELD_VALUE&$skip=0&$top=100" : {
					message : {
						value : [{
							FIELD_VALUE : "01"
						}, {
			...
			aRegExps : [{
				...
				regExp : /^GET [-\w\/;='.]+\.ET-BUSINESSPARTNER.CURRENCY_CODE'\/\$metadata\?sap-language=..$/,
