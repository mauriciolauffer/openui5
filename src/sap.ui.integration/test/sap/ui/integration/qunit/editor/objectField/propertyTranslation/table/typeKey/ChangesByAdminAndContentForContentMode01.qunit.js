							...
							oEditButton1.onAfterRendering = function(oEvent) {
								...
								EditorQunitUtils.wait().then(function () {
									...
									EditorQunitUtils.wait().then(function () {
										...
										oKeyCell1 = oRow1.getCells()[1];
										var sKeyPropertyValue = _oExpectedValuesOfChangesFromAdminAndContent["objectWithPropertiesDefined2"][sLanguageKey] || _oExpectedValuesOfChangesFromAdminAndContent["objectWithPropertiesDefined2"]["default"];
										...
										EditorQunitUtils.wait().then(function () {
											...
											assert.equal(oFormField1.getValue(), oValueOfObject2InContentChange.key, "SimpleForm 2 field 1:: Has value");
											...
											assert.ok(oValueHelpIcon2, "SimpleForm field 1:: Value help icon exist");
											...
											EditorQunitUtils.wait().then(function () {
												...
												EditorQunitUtils.wait().then(function () {
													...
													var oKeyCell1 = oRow1.getCells()[1];
													assert.equal(oKeyCell1.getText(), "string4", "Row 1: key cell value");
													...
													EditorQunitUtils.wait().then(function () {
														...
														assert.equal(oFormField1.getValue(), "string4", "SimpleForm 3 field 1:: Has value");
