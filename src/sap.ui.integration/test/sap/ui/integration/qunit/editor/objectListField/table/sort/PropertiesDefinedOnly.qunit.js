			...
			return new Promise(function (resolve, reject) {
				EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
					...
					EditorQunitUtils.wait().then(function () {
						...
						assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow1), oValue1Selected), "Table: row 1");
						...
						assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow2), oValue2Selected), "Table: row 2");
						...
						assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow3), oValue3Selected), "Table: row 3");
						...
						assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow4), oValue4Selected), "Table: row 4");
						...
						assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow5), oValue5Selected), "Table: row 5");
						...
						EditorQunitUtils.wait().then(function () {
							...
							assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow6), oValue6Selected), "Table: row 6");
							...
							assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow7), oValue7Selected), "Table: row 7");
							...
							assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow8), oValue8Selected), "Table: row 8");
				...
				EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
					...
					EditorQunitUtils.wait().then(function () {
						...
						EditorQunitUtils.wait().then(function () {
							...
							assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oField._getCurrentProperty("value")), aObjectsParameterValue1), "Field 1: Value");
							var oSettings = that.oEditor.getCurrentSettings();
							var oFieldSettings = oSettings[oField.getConfiguration().manifestpath];
							assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oFieldSettings), [oValue2, oValue1, oValue3, oValue4, oValue5, oValue6, oValue7, oValue8]), "Editor: Field 1 Value");

							oRow1 = oTable.getRows()[0];
							oValueOfRow1 = oRow1.getBindingContext().getObject();
							assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow1), oValue2Selected), "Table: value 2 move up to row 1");
							assert.equal(oValueOfRow1._dt._position, 1, "Table: row 1 position");
							...
							assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow2), oValue1Selected), "Table: value 1 move down to row 2");
							assert.equal(oValueOfRow2._dt._position, 2, "Table: row 2 position");
							...
							EditorQunitUtils.wait().then(function () {
								...
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oFieldSettings), aObjectsParameterValue1), "Editor: Field 1 Value");

								oRow1 = oTable.getRows()[0];
								oValueOfRow1 = oRow1.getBindingContext().getObject();
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow1), oValue1Selected), "Table: value 1 move up to row 1");
								assert.equal(oValueOfRow1._dt._position, 1, "Table: row 1 position");
								...
								oRow2 = oTable.getRows()[1];
								oValueOfRow2 = oRow2.getBindingContext().getObject();
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow2), oValue2Selected), "Table: value 2 move down to row 2");
								assert.equal(oValueOfRow2._dt._position, 2, "Table: row 2 position");
								...
								EditorQunitUtils.wait().then(function () {
									...
									oRow1 = oTable.getRows()[0];
									oValueOfRow1 = oRow1.getBindingContext().getObject();
									assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow1), oValue1Selected), "Table: value 1 not change");
									assert.equal(oValueOfRow1._dt._position, 1, "Table: row 1 position");
									assert.equal(oField._getCurrentProperty("value")[0]._dt._position, 1, "Table: value 1 position");
									assert.equal(oFieldSettings[0]._dt._position, 1, "Editor: Field 1 value 1 position");
									...
									oRow2 = oTable.getRows()[1];
									oValueOfRow2 = oRow2.getBindingContext().getObject();
									assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow2), oValue2Selected), "Table: value 2 not change");
									assert.equal(oValueOfRow2._dt._position, 2, "Table: row 2 position");
									assert.equal(oField._getCurrentProperty("value")[1]._dt._position, 2, "Table: value 2 position");
									assert.equal(oFieldSettings[1]._dt._position, 2, "Editor: Field 1 value 2 position");
									resolve();
					...
					EditorQunitUtils.wait().then(function () {
						...
						EditorQunitUtils.wait().then(function () {
							...
							EditorQunitUtils.wait().then(function () {
								...
								var oSettings = that.oEditor.getCurrentSettings();
								var oFieldSettings = oSettings[oField.getConfiguration().manifestpath];
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oFieldSettings), [oValue1, oValue2, oValue3, oValue4, oValue5, oValue6, oValue8, oValue7]), "Editor: Field 1 Value");

								oRow7 = oTable.getRows()[3];
								oValueOfRow7 = oRow7.getBindingContext().getObject();
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow7), oValue8Selected), "Table: value 8 move up to row 7");
								assert.equal(oValueOfRow7._dt._position, 7, "Table: row 7 position");
								...
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow8), oValue7Selected), "Table: value 7 move down to row 8");
								assert.equal(oValueOfRow8._dt._position, 8, "Table: row 8 position");
								...
								EditorQunitUtils.wait().then(function () {
									...
									oRow7 = oTable.getRows()[3];
									oValueOfRow7 = oRow7.getBindingContext().getObject();
									assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow7), oValue8Selected), "Table: value 8");
									assert.equal(oValueOfRow7._dt._position, 7, "Table: row 7 position");
									assert.equal(oField._getCurrentProperty("value")[7]._dt._position, 7, "Table: value 7 position");
									assert.equal(oFieldSettings[6]._dt._position, 7, "Editor: Field 1 value 7 position");
									...
									oRow8 = oTable.getRows()[4];
									oValueOfRow8 = oRow8.getBindingContext().getObject();
									assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow8), oValue7Selected), "Table: value 7");
									assert.equal(oValueOfRow8._dt._position, 8, "Table: row 8 position");
									assert.equal(oField._getCurrentProperty("value")[6]._dt._position, 8, "Table: value 8 position");
									assert.equal(oFieldSettings[7]._dt._position, 8, "Editor: Field 1 value 8 position");
									...
									EditorQunitUtils.wait().then(function () {
										...
										oRow7 = oTable.getRows()[3];
										oValueOfRow7 = oRow7.getBindingContext().getObject();
										assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow7), oValue7Selected), "Table: value 7 move up to row 7");
										assert.equal(oValueOfRow7._dt._position, 7, "Table: row 7 position");
										...
										oRow8 = oTable.getRows()[4];
										oValueOfRow8 = oRow8.getBindingContext().getObject();
										assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oValueOfRow8), oValue8Selected), "Table: value 8 move down to row 8");
										assert.equal(oValueOfRow8._dt._position, 8, "Table: row 8 position");
					...
					oAddButton.onAfterRendering = function(oEvent) {
						...
						EditorQunitUtils.wait().then(function () {
							...
							EditorQunitUtils.wait().then(function () {
								...
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oField._getCurrentProperty("value")), aObjectsParameterValue1.concat([oDefaultNewObject])), "Field 1: Value changed");
								assert.equal(oField._getCurrentProperty("value")[8]._dt._position, 9, "Table: added value position");
								var oSettings = that.oEditor.getCurrentSettings();
								var oFieldSettings = oSettings[oField.getConfiguration().manifestpath];
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oFieldSettings), [oValue1, oValue2, oValue3, oValue4, oValue5, oValue6, oValue7, oValue8, oDefaultNewObject]), "Editor: Field 1 Value");
					...
					oDeleteButton.onAfterRendering = function(oEvent) {
						...
						EditorQunitUtils.wait().then(function () {
							...
							EditorQunitUtils.wait().then(function () {
								...
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(aFieldValue), [oValue2, oValue3, oValue4, oValue5, oValue6, oValue7, oValue8]), "Field 1: Value updated");
								...
								var oSettings = that.oEditor.getCurrentSettings();
								var oFieldSettings = oSettings[oField.getConfiguration().manifestpath];
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oFieldSettings), [oValue2, oValue3, oValue4, oValue5, oValue6, oValue7, oValue8]), "Editor: Field 1 Value");
