			...
			return new Promise(function (resolve, reject) {
				...
				EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(that.oEditor).then(function () {
						...
						assert.equal(oLabel1.getText(), "string1label", "Label1: string1label - " + oLabel1.getText());
						assert.equal(oField1.getAggregation("_field").getValue(), "string1", "oField1: string1");
						assert.ok(oField1.getAggregation("_field").isA("sap.m.Input"), "oField1: Input control");
						assert.equal(oLabel2.getText(), "string2label", "Label2: string2label");
						...
						assert.equal(oLabel3.getText(), "string3label", "Label3: string3label");
						...
						assert.equal(oLabel4.getText(), "string4label", "Label4: string4label");
						assert.equal(oField4.getAggregation("_field").getValue(), "string4", "oField1: string4");
						...
						oField1.attachEventOnce("translationPopoverOpened", function () {
							...
							assert.equal(aHeaderItems1[2].getItems()[1].getValue(), "string1", "oTranslationPopover1 Header: string1");
							...
							oField3.attachEventOnce("translationPopoverOpened", function () {
								...
								oField4.attachEventOnce("translationPopoverOpened", function () {
									...
									assert.equal(aHeaderItems4[2].getItems()[1].getValue(), "string4", "oTranslationPopover4 Header: string4");
		...
		QUnit.test("Content mode", function (assert) {
			...
			return new Promise(function (resolve, reject) {
				...
				EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(that.oEditor).then(function () {
						assert.ok(that.oEditor.isReady(), "Editor is ready");
						assert.equal(oLabel1.getText(), "string1label", "Label1: string1label");
						assert.equal(oField1.getAggregation("_field").getValue(), "string1", "oField1: string1");
						assert.ok(oField1.getAggregation("_field").isA("sap.m.Input"), "oField1: Input control");
						assert.equal(oLabel2.getText(), "string2label", "Label2: string2label");
						assert.equal(oField2.getAggregation("_field").getValue(), "String 2", "oField2: String 2");
					...
					return new Promise(function (resolve, reject) {
						...
						EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
							...
							EditorQunitUtils.wait().then(function () {
								...
								assert.equal(oField1Trans.getAggregation("_field").getValue(), "string1", "Field1Trans: string1");
								...
								assert.equal(oField4Ori.getAggregation("_field").getText(), "string4", "Field4Ori: string4");
