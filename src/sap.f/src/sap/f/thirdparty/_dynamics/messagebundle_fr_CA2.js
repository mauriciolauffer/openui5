sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var BARCODE_SCANNER_DIALOG_LOADING_TXT = "Téléversement en cours";
	var DYNAMIC_PAGE_ARIA_LABEL_EXPANDED_HEADER = "En-tête développé";
	var DYNAMIC_PAGE_ARIA_LABEL_SNAPPED_HEADER = "En-tête ancré";
	var DYNAMIC_PAGE_ARIA_LABEL_EXPAND_HEADER = "Développer l''en-tête";
	var DYNAMIC_PAGE_ARIA_LABEL_SNAP_HEADER = "Ancrer l''en-tête";
	var DYNAMIC_PAGE_ARIA_LABEL_PIN_HEADER = "Épingler l''en-tête";
	var DYNAMIC_PAGE_ARIA_LABEL_UNPIN_HEADER = "Désépingler l''en-tête";
	var DYNAMIC_PAGE_ARIA_DESCR_TOGGLE_HEADER = "Afficher/Masquer l''en-tête";
	...
	var FCL_START_SEPARATOR_TOOLTIP = "Redimensionner à l''aide de la barre entre les colonnes de début et de milieu";
	var FCL_END_SEPARATOR_TOOLTIP = "Redimensionner à l''aide de la barre entre les colonnes de milieu et de fin";
	...
	var NOTIFICATION_LIST_ITEM_MORE_LINK_LABEL_TRUNCATE = "Bouton Moins. Affiche des textes tronqués.";
	var NOTIFICATION_LIST_ITEM_CLOSE_BTN_TITLE = "Fermer";
	var NOTIFICATION_LIST_ITEM_LOADING = "Téléversement en cours";
	var NOTIFICATION_LIST_ITEM_READ = "Lue";
	var NOTIFICATION_LIST_ITEM_UNREAD = "Non lue";
	var NOTIFICATION_LIST_ITEM_INFORMATION_STATUS_TXT = "Information sur l’état";
	var NOTIFICATION_LIST_ITEM_POSITIVE_STATUS_TXT = "État Positif";
	var NOTIFICATION_LIST_ITEM_NEGATIVE_STATUS_TXT = "État Négatif";
	var NOTIFICATION_LIST_ITEM_CRITICAL_STATUS_TXT = "État Critique";
	...
	var TIMELINE_ITEM_INFORMATION_STATE_TEXT = "Statut des informations";
	var TIMELINE_ITEM_POSITIVE_STATE_TEXT = "Statut Positif";
	var TIMELINE_ITEM_NEGATIVE_STATE_TEXT = "Statut Négatif";
	var TIMELINE_ITEM_CRITICAL_STATE_TEXT = "Statut Critique";
	...
	var UPLOADCOLLECTIONITEM_UPLOADING_STATE = "Téléversement en cours";
	...
	var UPLOADCOLLECTION_NO_DATA_DESCRIPTION = "Déposez des fichiers pour les téléverser ou utilisez le bouton \"Téléverser\".";
	...
	var UPLOADCOLLECTION_DROP_FILE_INDICATOR = "Déposez des fichiers pour les téléverser.";
	var SHELLBAR_LABEL = "Barre d''interpréteur de commandes";
	var SHELLBAR_LOGO = "Logo";
	var SHELLBAR_LOGO_AREA = "{0} {1}";
	var SHELLBAR_ADDITIONAL_CONTEXT = "Renseignements supplémentaires";
	var SHELLBAR_SEARCHFIELD_DESCRIPTION = "Les résultats de la recherche s''afficheront dans la zone principale.";
	...
	var SHELLBAR_PRODUCT_SWITCH_BTN = "Sélecteur de produit";
	var PRODUCT_SWITCH_CONTAINER_LABEL = "Produits";
	var SHELLBAR_SEARCH = "Rechercher";
	var SHELLBAR_SEARCH_FIELD = "Champ de recherche";
	var SHELLBAR_SEARCH_BTN_OPEN = "Ouvrir la recherche";
	var SEARCH_ITEM_DELETE_BUTTON = "Supprimer la suggestion";
	var SHELLBAR_OVERFLOW = "Plus";
	var SHELLBAR_CANCEL = "Annuler";
	var WIZARD_NAV_ARIA_LABEL = "Barre d''avancement de l''assistant";
	var WIZARD_CANCEL_BUTTON = "Annuler";
	var WIZARD_LIST_ARIA_LABEL = "Étapes de l''assistant";
	var WIZARD_LIST_ARIA_DESCRIBEDBY = "Pour activer, appuyez sur la barre d''espace ou sur la touche Entrée.";
	...
	var VSD_DIALOG_TITLE_SORT = "Paramètres d''affichage";
	var VSD_SUBMIT_BUTTON = "OK";
	var VSD_CANCEL_BUTTON = "Annuler";
	var VSD_RESET_BUTTON = "Réinitialiser";
	var VSD_RESET_BUTTON_ACTION = "L''action ''Réinitialiser'' a réinitialisé tous les paramètres à leur valeur initiale.";
	var VSD_SORT_TOOLTIP = "Trier";
	var VSD_FILTER_TOOLTIP = "Filtrer";
	var VSD_GROUP_TOOLTIP = "Regrouper";
	var VSD_SORT_ORDER = "Ordre du tri";
	var VSD_GROUP_ORDER = "Ordre du regroupement";
	var VSD_FILTER_BY = "Filtrer par";
	var VSD_SORT_BY = "Trier par";
	var VSD_GROUP_BY = "Regrouper par";
	var VSD_ORDER_ASCENDING = "Croissant";
	var VSD_ORDER_DESCENDING = "Décroissant";
	var VSD_FILTER_ITEM_LABEL_TEXT = "{0} Compteur {1}";
	var IM_SUBTITLE_ACHIEVEMENT = "Félicitations pour votre performance et votre détermination exceptionnelles.";
	var IM_TITLE_ACHIEVEMENT = "Excellent travail!";
	var IM_SUBTITLE_USERHASSIGNEDUP = "Vous avez configuré votre compte. Voulez-vous en faire une visite rapide?";
	var IM_TITLE_USERHASSIGNEDUP = "Opération réussie";
	...
	var IM_SUBTITLE_NOCOLUMNSSET = "Sélectionnez les colonnes dont vous avez besoin dans les paramètres du tableau.";
	...
	var IM_TITLE_NOMAIL = "Aucun courriel";
	var IM_SUBTITLE_NOMAIL = "Vérifiez à nouveau ultérieurement.";
	var IM_TITLE_NOENTRIES = "Aucune donnée n''est disponible pour l''instant.";
	var IM_SUBTITLE_NOENTRIES = "Lorsque des tâches seront disponibles, vous les verrez ici.";
	var IM_TITLE_NONOTIFICATIONS = "Aucune notification";
	var IM_SUBTITLE_NONOTIFICATIONS = "Vérifiez à nouveau ultérieurement.";
	var IM_TITLE_NOSAVEDITEMS = "Aucun élément épinglé";
	var IM_SUBTITLE_NOSAVEDITEMS = "Voulez-vous en ajouter un maintenant?";
	var IM_TITLE_NOSEARCHRESULTS = "Aucun résultat.";
	var IM_SUBTITLE_NOSEARCHRESULTS = "Essayez d''ajuster votre recherche.";
	var IM_TITLE_NOTASKS = "Vous n''avez aucune tâche.";
	var IM_SUBTITLE_NOTASKS = "Lorsque des tâches seront disponibles, vous les verrez ici.";
	var IM_TITLE_UNABLETOLOAD = "Impossible de charger les données";
	var IM_SUBTITLE_UNABLETOLOAD = "Vérifiez votre connexion Internet. Sinon, essayez de recharger les données. Si le problème persiste, contactez l''administrateur.";
	var IM_TITLE_UNABLETOLOADIMAGE = "Impossible de charger l''image";
	var IM_SUBTITLE_UNABLETOLOADIMAGE = "Nous n''avons pas trouvé l''image à l''emplacement spécifié, ou bien le serveur ne répond pas.";
	var IM_TITLE_UNABLETOUPLOAD = "Impossible de téléverser les données";
	...
	var IM_SUBTITLE_ADDCOLUMN = "Vous pouvez ajouter plus de colonnes dans les paramètres de table.";
	...
	var IM_SUBTITLE_GROUPTABLE = "Vous pouvez opter pour le regroupement des catégories dans les paramètres de groupe.";
	var IM_TITLE_NEWMAIL = "Nouveau courriel";
	var IM_SUBTITLE_NEWMAIL = "Vous avez un nouveau courriel dans votre boîte de réception.";
	...
	var IM_SUBTITLE_SIGNOUT = "Vous pouvez maintenant fermer cette fenêtre.";
	var IM_TITLE_SORTCOLUMN = "Les éléments les plus importants ne sont pas affichés en premier?";
	var IM_SUBTITLE_SORTCOLUMN = "Sélectionnez les critères de tri dans les paramètres de tri.";
	...
	var IM_SUBTITLE_UPLOADCOLLECTION = "Vous pouvez également téléverser plusieurs fichiers en même temps.";
	...
	var IM_SUBTITLE_NODIMENSIONSSET = "Essayez d''ajuster vos paramètres de diagramme.";
	...
	var DSC_MAIN_ARIA_LABEL = "Contenu principal";
	var DSC_SIDE_ARIA_LABEL = "Contenu latéral";
	var SEARCH_FIELD_SCOPE_SELECT_LABEL = "Sélectionner le périmètre";
	var SEARCH_FIELD_LABEL = "Champ de recherche";
	var SEARCH_FIELD_CLEAR_ICON = "Réinitialiser la recherche";
	var SEARCH_FIELD_SEARCH_ICON = "Rechercher";
	var SEARCH_ITEM_SHOW_MORE_NO_COUNT = "Afficher plus";
	var SEARCH_ITEM_SHOW_MORE_COUNT = "Afficher plus ({0})";
	var SHELLBAR_SEARCH_COLLAPSED = "Ouvrir la recherche";
	var SHELLBAR_SEARCH_EXPANDED = "Réduire la recherche";
	var SEARCH_CANCEL_BUTTON = "Annuler";
	...
	var SIDE_NAVIGATION_COLLAPSED_LIST_ITEMS_ARIA_ROLE_DESC = "Élément de menu de liste de navigation";
	...
	var SIDE_NAVIGATION_OVERFLOW_ITEM_LABEL = "Affiche les éléments de navigation restants";
	var SIDE_NAVIGATION_FLEXIBLE_LIST_LABEL = "Menu de navigation princip.";
	var SIDE_NAVIGATION_FIXED_LIST_LABEL = "Menu de navigation de pied de page";
	var SIDE_NAVIGATION_ICON_COLLAPSE = "Réduire";
	var SIDE_NAVIGATION_ICON_EXPAND = "Développer";
	var USER_MENU_OTHER_ACCOUNT_BUTTON_TXT = "Autres comptes";
	var USER_MENU_CLOSE_BUTTON_TXT = "Fermer";
	var USER_MENU_MANAGE_ACCOUNT_BUTTON_TXT = "Gérer le compte";
	var USER_MENU_SIGN_OUT_BUTTON_TXT = "Déconnexion";
	var USER_MENU_EDIT_AVATAR_TXT = "Modifier l''avatar";
	var USER_MENU_EDIT_ACCOUNTS_TXT = "Modifier les comptes";
	var USER_MENU_POPOVER_ACCESSIBLE_NAME = "Menu utilisateur pour";
	var USER_MENU_CLOSE_DIALOG_BUTTON = "Refuser";
	var USER_MENU_POPOVER_ACCESSIBLE_ACCOUNT_SELECTED_TXT = "Sélectionné";
	var USER_MENU_CURRENT_INFORMATION_TXT = "Informations utilisateur actuel";
	var USER_MENU_ACTIONS_TXT = "Actions";
	var USER_SETTINGS_DIALOG_ACCESSIBLE_NAME = "Dialogue des paramètres utilisateur";
	var USER_SETTINGS_LIST_ARIA_ROLE_DESC = "Élément des paramètres utilisateur";
	var USER_SETTINGS_DIALOG_CLOSE_BUTTON_TEXT = "Fermer";
	var USER_SETTINGS_DIALOG_NO_SEARCH_RESULTS_TEXT = "Aucun résultat de recherche";
