			...
			return new Promise(function (resolve, reject) {
				EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(this.oEditor).then(function () {
						...
						assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oField._getCurrentProperty("value")), [{"string":"string value", "boolean": true, "integer": 5, "number": 5.22}]), "Field 1: DT Value created");

						sNewValue = '[{\n\t"string1": "string value 1",\n\t"boolean": true,\n\t"integer": 5,\n\t"number": 5.22\n}]';
						oTextArea.setValue(sNewValue);
						oTextArea.fireChange({ value: sNewValue});
						assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oField._getCurrentProperty("value")), [{"string1":"string value 1", "boolean": true, "integer": 5, "number": 5.22}]), "Field 1: DT Value updated");

						sNewValue = '[]';
						oTextArea.setValue(sNewValue);
						oTextArea.fireChange({ value: sNewValue});
						assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oField._getCurrentProperty("value")), []), "Field 1: DT Value updated");
			...
			return new Promise(function (resolve, reject) {
				EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(this.oEditor).then(function () {
						...
						oTextArea.setValue(sNewValue);
						oTextArea.fireChange({ value: sNewValue});
						assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oField._getCurrentProperty("value")), [{"string":"string value", "boolean": true, "integer": 5, "number": 5.22}]), "Field 1: DT Value updated");
			...
			return new Promise(function (resolve, reject) {
				EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(this.oEditor).then(function () {
						...
						assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oRow1.getBindingContext().getObject()), {"a": "aa", "b": "bb", "d": 2, "_dt": {"_selected": true}}), "Row 1: value");
						var oRow2 = oTable.getRows()[1];
						assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oRow2.getBindingContext().getObject()), {"b": "bbb", "c": "ccc", "d": 3, "_dt": {"_selected": true}}), "Row 2: value");
						var oRow3 = oTable.getRows()[2];
						assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oRow3.getBindingContext().getObject()), {"c": "cccc", "d": 1, "a": "aaaa", "e": false, "_dt": {"_selected": true}}), "Row 3: value");
						var oRow4 = oTable.getRows()[3];
						assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oRow4.getBindingContext().getObject()), {"a": "aaa", "b": "bbb", "e": true, "_dt": {"_selected": true}}), "Row 4: value");
				...
				EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(this.oEditor).then(function () {
						...
						EditorQunitUtils.wait().then(function () {
							...
							assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oContents[11].getValue()), {"_dt": {"_selected": true}}), "SimpleForm field textArea: Has value");
							...
							assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oFormField.getValue()), {"_dt": {"_selected": true},"a": "a1","b": "b1","d": 2,"c": "c1","e": true}), "SimpleForm field textArea: Has updated value");
							oAddButtonInPopover.firePress();
							EditorQunitUtils.wait().then(function () {
								assert.equal(oTable.getBinding().getCount(), 5, "Table: value length is 5");
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oTable.getBinding().getContexts()[4].getObject()), {"a": "a1","b": "b1","c": "c1","d": 2,"e": true, "_dt": {"_selected": true}}), "Table: new row");
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oField._getCurrentProperty("value")), aObjectsParameterValue.concat([{"a": "a1","b": "b1","c": "c1","d": 2,"e": true}])), "Field 1: updated DT Value");
								resolve();
							});
						});
					}.bind(this));
				...
				EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(this.oEditor).then(function () {
						...
						EditorQunitUtils.wait().then(function () {
							...
							EditorQunitUtils.wait().then(function () {
								assert.equal(oTable.getBinding().getCount(), 5, "Table: value length is 5");
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oTable.getBinding().getContexts()[4].getObject()), {"a": "a2","b": "b2","c": "c2","d": 3,"e": false, "_dt": {"_selected": true}}), "Table: new row");
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oField._getCurrentProperty("value")), aObjectsParameterValue.concat([{"a": "a2","b": "b2","c": "c2","d": 3,"e": false}])), "Field 1: updated DT Value");
								resolve();
							});
						});
					}.bind(this));
				...
				EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(this.oEditor).then(function () {
						...
						EditorQunitUtils.wait().then(function () {
							...
							var oContents = oSimpleForm.getContent();
							assert.equal(oContents.length, 12, "SimpleForm: length");
							assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oContents[11].getValue()), {"c": "cccc","d": 1,"a": "aaaa","e": false,"_dt": {"_selected": true}}), "SimpleForm field textArea: Has value");
							var oFormLabel = oContents[0];
							var oFormField = oContents[1];
							assert.equal(oFormLabel.getText(), "a", "SimpleForm label1: Has label text");
							assert.ok(oFormLabel.getVisible(), "SimpleForm label1: Visible");
							...
							assert.ok(!oFormField.getVisible(), "SimpleForm Field8: Not Visible");
							assert.ok(oFormField.getEditable(), "SimpleForm Field8: Editable");
							assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oFormField.getValue()), {"c": "c1","d": 2,"a": "a1","e": true,"_dt": {"_selected": true},"b": "b1"}), "SimpleForm field textArea: Has updated value");
							oUpdateButtonInPopover.firePress();
							EditorQunitUtils.wait().then(function () {
								assert.equal(oTable.getBinding().getCount(), aObjectsParameterValue.length, "Table: value length is " + aObjectsParameterValue.length);
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oTable.getBinding().getContexts()[2].getObject()), {"a": "a1","b": "b1","c": "c1","d": 2,"e": true,"_dt": {"_selected": true}}), "Table: row updated");
				...
				EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(this.oEditor).then(function () {
						...
						EditorQunitUtils.wait().then(function () {
							...
							EditorQunitUtils.wait().then(function () {
								assert.equal(oTable.getBinding().getCount(), aObjectsParameterValue.length, "Table: value length is " + aObjectsParameterValue.length);
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oTable.getBinding().getContexts()[2].getObject()), {"c": "cccc", "d": 1, "a": "aaaa", "e": false, "_dt": {"_selected": true}}), "Table: row not updated");
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oField._getCurrentProperty("value")), aObjectsParameterValue), "Field 1: DT Value");
								resolve();
							});
						});
				...
				EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(this.oEditor).then(function () {
						...
						EditorQunitUtils.wait().then(function () {
							...
							assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(sValue), {"c": "c1","d": 2,"a": "a1","e": true,"_dt": {"_selected": true},"b": "b1"}), "SimpleForm field textArea: Has updated value");
							var sNewValue = '{\n\t"c": "c2",\n\t"d": 3,\n\t"a": "a2",\n\t"e": false,\n\t"_dt": {\n\t\t"_selected": true,\n\t\t"_position": ' + iPosition + '\n\t},\n\t"b": "b2"\n}';
							oFormField.setValue(sNewValue);
							oFormField.fireChange({ value: sNewValue});
							oUpdateButtonInPopover.firePress();
							EditorQunitUtils.wait().then(function () {
								assert.equal(oTable.getBinding().getCount(), aObjectsParameterValue.length, "Table: value length is " + aObjectsParameterValue.length);
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oTable.getBinding().getContexts()[2].getObject()), {"c": "c2", "d": 3, "a": "a2", "e": false, "b": "b2", "_dt": {"_selected": true}}), "Table: row updated");
								assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oField._getCurrentProperty("value")), [
									{"a": "aa", "b": "bb", "d": 2},
									{"b": "bbb", "c": "ccc", "d": 3},
