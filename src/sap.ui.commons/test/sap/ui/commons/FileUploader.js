sap.ui.define([
...
], function(Log, Button, Label, MessageBox, TextField, XMLView, Controller, FileUploader, FileUploaderParameter) {
	"use strict";
	...
	var oTVProgress = new TextField({
		value: "progress messages go here"
	});
	oTVProgress.placeAt("progressMsgs");

	var oTVComplete = new TextField({
		value: "complete messages go here"
	});
