			...
			return new Promise(function (resolve, reject) {
				...
				EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(that.oEditor).then(function () {
						...
						assert.equal(oField1.getAggregation("_field").getValue(), "String1 Value Content", "oField1: String1 Value");
						...
						assert.equal(oField4.getAggregation("_field").getValue(), "String4 Value Content", "oField4: String4 Value");
						...
						oField1.attachEventOnce("translationPopoverOpened", function () {
							...
							assert.equal(aHeaderItems1[2].getItems()[1].getValue(), "String1 Value Content", "oTranslationPopover1 Header: String1 Value");
							...
							oField3.attachEventOnce("translationPopoverOpened", function () {
								...
								oField4.attachEventOnce("translationPopoverOpened", function () {
									...
									assert.equal(aHeaderItems4[2].getItems()[1].getValue(), "String4 Value Content", "oTranslationPopover4 Header: String4 Value");
