sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var DYNAMIC_PAGE_ARIA_LABEL_UNPIN_HEADER = "取消固定抬头";
	...
	var TIMELINE_ITEM_INFORMATION_STATE_TEXT = "信息状态";
	var TIMELINE_ITEM_POSITIVE_STATE_TEXT = "正面状态";
	var TIMELINE_ITEM_NEGATIVE_STATE_TEXT = "负面状态";
	var TIMELINE_ITEM_CRITICAL_STATE_TEXT = "关键状态";
	...
	var SHELLBAR_ADDITIONAL_CONTEXT = "附加信息";
	var SHELLBAR_SEARCHFIELD_DESCRIPTION = "将在主区域中显示搜索结果";
	var SHELLBAR_NOTIFICATIONS = "{0} 个通知";
	var SHELLBAR_NOTIFICATIONS_NO_COUNT = "通知";
	var SHELLBAR_PROFILE = "参数文件";
	var SHELLBAR_PRODUCTS = "产品";
	var SHELLBAR_PRODUCT_SWITCH_BTN = "产品切换器";
	var PRODUCT_SWITCH_CONTAINER_LABEL = "产品";
	var SHELLBAR_SEARCH = "搜索";
	var SHELLBAR_SEARCH_FIELD = "搜索字段";
	var SHELLBAR_SEARCH_BTN_OPEN = "打开搜索";
	var SEARCH_ITEM_DELETE_BUTTON = "移除建议";
	...
	var VSD_RESET_BUTTON_ACTION = "重置已将所有设置还原到初始状态";
	var VSD_SORT_TOOLTIP = "排序";
	var VSD_FILTER_TOOLTIP = "过滤器";
	var VSD_GROUP_TOOLTIP = "分组";
	var VSD_SORT_ORDER = "排序顺序";
	var VSD_GROUP_ORDER = "分组顺序";
	var VSD_FILTER_BY = "过滤条件";
	var VSD_SORT_BY = "排序方式";
	var VSD_GROUP_BY = "分组依据";
	var VSD_ORDER_ASCENDING = "升序";
	var VSD_ORDER_DESCENDING = "降序";
	var VSD_FILTER_ITEM_LABEL_TEXT = "{0} 计数器 {1}";
	var IM_SUBTITLE_ACHIEVEMENT = "祝贺您突出的表现和努力！";
	var IM_TITLE_ACHIEVEMENT = "做得好！";
	var IM_SUBTITLE_USERHASSIGNEDUP = "您已设置了账户。是否要进行快速游览？";
	...
	var IM_TITLE_NOMAIL = "无任何邮件";
	var IM_SUBTITLE_NOMAIL = "稍后再查阅。";
	var IM_TITLE_NOENTRIES = "还没有任何条目";
	var IM_SUBTITLE_NOENTRIES = "有数据时，将会在此看到。";
	var IM_TITLE_NONOTIFICATIONS = "没有通知";
	var IM_SUBTITLE_NONOTIFICATIONS = "稍后再查阅。";
	var IM_TITLE_NOSAVEDITEMS = "没有个人识别号";
	var IM_SUBTITLE_NOSAVEDITEMS = "是否要立即添加？";
	var IM_TITLE_NOSEARCHRESULTS = "无法找到此项。";
	var IM_SUBTITLE_NOSEARCHRESULTS = "尝试调整搜索。";
	var IM_TITLE_NOTASKS = "没有任何任务";
	...
	var DSC_MAIN_ARIA_LABEL = "主要内容";
	var DSC_SIDE_ARIA_LABEL = "侧面内容";
	var SEARCH_FIELD_SCOPE_SELECT_LABEL = "选择范围";
	var SEARCH_FIELD_LABEL = "搜索字段";
	var SEARCH_FIELD_CLEAR_ICON = "清除搜索";
	var SEARCH_FIELD_SEARCH_ICON = "搜索";
	var SEARCH_ITEM_SHOW_MORE_NO_COUNT = "显示更多";
	var SEARCH_ITEM_SHOW_MORE_COUNT = "显示更多 ({0})";
	var SHELLBAR_SEARCH_COLLAPSED = "打开搜索";
	var SHELLBAR_SEARCH_EXPANDED = "折叠搜索";
	var SEARCH_CANCEL_BUTTON = "取消";
	var SEARCH_SUGGESTIONS = "建议";
	...
	var SIDE_NAVIGATION_OVERFLOW_ITEM_LABEL = "显示其余导航项目";
	var SIDE_NAVIGATION_FLEXIBLE_LIST_LABEL = "主导航菜单";
	var SIDE_NAVIGATION_FIXED_LIST_LABEL = "页脚导航菜单";
	var SIDE_NAVIGATION_ICON_COLLAPSE = "折叠";
	var SIDE_NAVIGATION_ICON_EXPAND = "展开";
	...
	var USER_MENU_EDIT_ACCOUNTS_TXT = "编辑账户";
	var USER_MENU_POPOVER_ACCESSIBLE_NAME = "相应的用户菜单";
	var USER_MENU_CLOSE_DIALOG_BUTTON = "拒绝";
	var USER_MENU_POPOVER_ACCESSIBLE_ACCOUNT_SELECTED_TXT = "已选择";
	var USER_MENU_CURRENT_INFORMATION_TXT = "当前用户信息";
	var USER_MENU_ACTIONS_TXT = "操作";
	var USER_SETTINGS_DIALOG_ACCESSIBLE_NAME = "用户设置对话框";
	var USER_SETTINGS_LIST_ARIA_ROLE_DESC = "用户设置项目";
	var USER_SETTINGS_DIALOG_CLOSE_BUTTON_TEXT = "关闭";
	var USER_SETTINGS_DIALOG_NO_SEARCH_RESULTS_TEXT = "无搜索结果";
