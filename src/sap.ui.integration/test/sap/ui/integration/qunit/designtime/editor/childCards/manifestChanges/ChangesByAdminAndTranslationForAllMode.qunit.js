				...
				return new Promise(function (resolve, reject) {
					EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
						...
						EditorQunitUtils.isReady(that.oEditor).then(function () {
							...
							var sExpectedValue = _oExpectedCardTitleValues["main"]["default"];
							...
							oTitleField.attachEventOnce("translationPopoverOpened",async function () {
								...
								var sExpectedValueInPopoverTitle = _oExpectedCardTitleValues["main"]["default"];
								...
								for (var i = 0; i < oLanguageItems1.length; i++) {
									...
									var sExpectedValueInPopoveItem = _oExpectedCardTitleValues["main"][sLanguage] || _oExpectedCardTitleValues["main"]["defaultOri_in_trans"];
								...
								EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
									...
									EditorQunitUtils.isReady(that.oEditor).then(function () {
										...
										assert.ok(oTitleField.isA("sap.ui.integration.editor.fields.StringField"), "Title Field: String Field");
										assert.ok(oTitleFieldControl.isA("sap.m.Input"), "Title Field: Control is an Input");
										sExpectedValue = _oExpectedCardTitleValues["child1"]["default"];
										assert.equal(oTitleFieldControl.getValue(), sExpectedValue, "Title Field: String Value");
										...
										oTitleField.attachEventOnce("translationPopoverOpened",async function () {
											...
											assert.equal(aHeaderItems1[1].getText(), that.oEditor._oResourceBundle.getText("EDITOR_FIELD_TRANSLATION_LIST_POPOVER_CURRENTLANGUAGE"), "oTranslationPopover1 Header: Current Language");
											assert.equal(aHeaderItems1[2].getItems()[0].getText(), oLanguage.description, "oTranslationPopover1 Header: English");
											sExpectedValueInPopoverTitle = _oExpectedCardTitleValues["child1"]["default"];
											assert.equal(aHeaderItems1[2].getItems()[1].getValue(), sExpectedValueInPopoverTitle, "oTranslationPopover1 Header: Title Value");
											assert.equal(aHeaderItems1[2].getItems()[1].getEditable(), false, "oTranslationPopover1 Header: Editable false");
											assert.equal(aHeaderItems1[3].getText(), that.oEditor._oResourceBundle.getText("EDITOR_FIELD_TRANSLATION_LIST_POPOVER_OTHERLANGUAGES"), "oTranslationPopover1 Header: Other Languages");
											assert.ok(oTranslationPopover1.getContent()[0].isA("sap.m.List"), "oTranslationPopover1 Content: List");
											...
											for (var i = 0; i < oLanguageItems1.length; i++) {
												var sLanguage = oLanguageItems1[i].getCustomData()[0].getKey();
												var sExpectedValueInPopoveItem = _oExpectedCardTitleValues["child1"][sLanguage] || _oExpectedCardTitleValues["child1"]["defaultOri_in_trans"];
												var sCurrentValue = oLanguageItems1[i].getContent()[0].getItems()[1].getValue();
												assert.equal(sCurrentValue, sExpectedValueInPopoveItem, "oTranslationPopover1 Content: item " + i + " " + sLanguage + ", current: " + sCurrentValue + ", expected: " + sExpectedValueInPopoveItem);
											}
											...
											EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
												...
												EditorQunitUtils.isReady(that.oEditor).then(function () {
													...
													assert.ok(oTitleField.isA("sap.ui.integration.editor.fields.StringField"), "Title Field: String Field");
													assert.ok(oTitleFieldControl.isA("sap.m.Input"), "Title Field: Control is an Input");
													sExpectedValue = _oExpectedCardTitleValues["child1-1"][sLanguageKey] || _oExpectedCardTitleValues["child1-1"]["default"];
													assert.equal(oTitleFieldControl.getValue(), sExpectedValue, "Title Field: String Value");
													...
													oTitleField.attachEventOnce("translationPopoverOpened",async function () {
														...
														assert.equal(aHeaderItems1[1].getText(), that.oEditor._oResourceBundle.getText("EDITOR_FIELD_TRANSLATION_LIST_POPOVER_CURRENTLANGUAGE"), "oTranslationPopover1 Header: Current Language");
														assert.equal(aHeaderItems1[2].getItems()[0].getText(), oLanguage.description, "oTranslationPopover1 Header: English");
														sExpectedValueInPopoverTitle = _oExpectedCardTitleValues["child1-1"][sLanguageKey] || _oExpectedCardTitleValues["child1-1"]["default"];
														assert.equal(aHeaderItems1[2].getItems()[1].getValue(), sExpectedValueInPopoverTitle, "oTranslationPopover1 Header: Title Value");
														assert.equal(aHeaderItems1[2].getItems()[1].getEditable(), false, "oTranslationPopover1 Header: Editable false");
														assert.equal(aHeaderItems1[3].getText(), that.oEditor._oResourceBundle.getText("EDITOR_FIELD_TRANSLATION_LIST_POPOVER_OTHERLANGUAGES"), "oTranslationPopover1 Header: Other Languages");
														assert.ok(oTranslationPopover1.getContent()[0].isA("sap.m.List"), "oTranslationPopover1 Content: List");
														...
														for (var i = 0; i < oLanguageItems1.length; i++) {
															var sLanguage = oLanguageItems1[i].getCustomData()[0].getKey();
															var sExpectedValueInPopoveItem = _oExpectedCardTitleValues["child1-1"][sLanguage] || _oExpectedCardTitleValues["child1-1"]["defaultOri_in_trans"];
															var sCurrentValue = oLanguageItems1[i].getContent()[0].getItems()[1].getValue();
															assert.equal(sCurrentValue, sExpectedValueInPopoveItem, "oTranslationPopover1 Content: item " + i + " " + sLanguage + ", current: " + sCurrentValue + ", expected: " + sExpectedValueInPopoveItem);
														}
														oCancelButton1 = oTranslationPopover1.getFooter().getContent()[2];
														...
														EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
															...
															EditorQunitUtils.isReady(that.oEditor).then(function () {
																...
																assert.ok(oTitleField.isA("sap.ui.integration.editor.fields.StringField"), "Title Field: String Field");
																assert.ok(oTitleFieldControl.isA("sap.m.Input"), "Title Field: Control is an Input");
																sExpectedValue = _oExpectedCardTitleValues["child1-2"]["default"];
																assert.equal(oTitleFieldControl.getValue(), sExpectedValue, "Title Field: String Value");
																...
																oTitleField.attachEventOnce("translationPopoverOpened",async function () {
																	...
																	assert.equal(aHeaderItems1[1].getText(), that.oEditor._oResourceBundle.getText("EDITOR_FIELD_TRANSLATION_LIST_POPOVER_CURRENTLANGUAGE"), "oTranslationPopover1 Header: Current Language");
																	assert.equal(aHeaderItems1[2].getItems()[0].getText(), oLanguage.description, "oTranslationPopover1 Header: English");
																	sExpectedValueInPopoverTitle = _oExpectedCardTitleValues["child1-2"]["default"];
																	assert.equal(aHeaderItems1[2].getItems()[1].getValue(), sExpectedValueInPopoverTitle, "oTranslationPopover1 Header: Title Value");
																	assert.equal(aHeaderItems1[2].getItems()[1].getEditable(), false, "oTranslationPopover1 Header: Editable false");
																	assert.equal(aHeaderItems1[3].getText(), that.oEditor._oResourceBundle.getText("EDITOR_FIELD_TRANSLATION_LIST_POPOVER_OTHERLANGUAGES"), "oTranslationPopover1 Header: Other Languages");
																	assert.ok(oTranslationPopover1.getContent()[0].isA("sap.m.List"), "oTranslationPopover1 Content: List");
																	...
																	for (var i = 0; i < oLanguageItems1.length; i++) {
																		var sLanguage = oLanguageItems1[i].getCustomData()[0].getKey();
																		var sExpectedValueInPopoveItem = _oExpectedCardTitleValues["child1-2"][sLanguage] || _oExpectedCardTitleValues["child1-2"]["defaultOri_in_trans"];
																		var sCurrentValue = oLanguageItems1[i].getContent()[0].getItems()[1].getValue();
																		assert.equal(sCurrentValue, sExpectedValueInPopoveItem, "oTranslationPopover1 Content: item " + i + " " + sLanguage + ", current: " + sCurrentValue + ", expected: " + sExpectedValueInPopoveItem);
																	}
																	oCancelButton1 = oTranslationPopover1.getFooter().getContent()[2];
							...
							oTitleField.attachEventOnce("translationPopoverOpened",async function () {
								...
								EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
									...
									EditorQunitUtils.isReady(that.oEditor).then(function () {
										...
										assert.ok(oTitleField.isA("sap.ui.integration.editor.fields.StringField"), "Title Field: String Field");
										assert.ok(oTitleFieldControl.isA("sap.m.Input"), "Title Field: Control is an Input");
										sExpectedValue = _oExpectedCardTitleValues["child2"][sLanguageKey] || _oExpectedCardTitleValues["child2"]["default"];
										assert.equal(oTitleFieldControl.getValue(), sExpectedValue, "Title Field: String Value");
										...
										oTitleField.attachEventOnce("translationPopoverOpened",async function () {
											...
											assert.equal(aHeaderItems1[1].getText(), that.oEditor._oResourceBundle.getText("EDITOR_FIELD_TRANSLATION_LIST_POPOVER_CURRENTLANGUAGE"), "oTranslationPopover1 Header: Current Language");
											assert.equal(aHeaderItems1[2].getItems()[0].getText(), oLanguage.description, "oTranslationPopover1 Header: English");
											sExpectedValueInPopoverTitle = _oExpectedCardTitleValues["child2"][sLanguageKey] || _oExpectedCardTitleValues["child2"]["default"];
											assert.equal(aHeaderItems1[2].getItems()[1].getValue(), sExpectedValueInPopoverTitle, "oTranslationPopover1 Header: Title Value");
											assert.equal(aHeaderItems1[2].getItems()[1].getEditable(), false, "oTranslationPopover1 Header: Editable false");
											assert.equal(aHeaderItems1[3].getText(), that.oEditor._oResourceBundle.getText("EDITOR_FIELD_TRANSLATION_LIST_POPOVER_OTHERLANGUAGES"), "oTranslationPopover1 Header: Other Languages");
											assert.ok(oTranslationPopover1.getContent()[0].isA("sap.m.List"), "oTranslationPopover1 Content: List");
											...
											for (var i = 0; i < oLanguageItems1.length; i++) {
												var sLanguage = oLanguageItems1[i].getCustomData()[0].getKey();
												var sExpectedValueInPopoveItem = _oExpectedCardTitleValues["child2"][sLanguage] || _oExpectedCardTitleValues["child2"]["defaultOri_in_trans"];
												var sCurrentValue = oLanguageItems1[i].getContent()[0].getItems()[1].getValue();
												assert.equal(sCurrentValue, sExpectedValueInPopoveItem, "oTranslationPopover1 Content: item " + i + " " + sLanguage + ", current: " + sCurrentValue + ", expected: " + sExpectedValueInPopoveItem);
											}
											oCancelButton1 = oTranslationPopover1.getFooter().getContent()[2];
											...
											EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
												...
												EditorQunitUtils.isReady(that.oEditor).then(function () {
													...
													assert.ok(oTitleField.isA("sap.ui.integration.editor.fields.StringField"), "Title Field: String Field");
													assert.ok(oTitleFieldControl.isA("sap.m.Input"), "Title Field: Control is an Input");
													sExpectedValue = _oExpectedCardTitleValues["child2-1"]["default"];
													assert.equal(oTitleFieldControl.getValue(), sExpectedValue, "Title Field: String Value");
													...
													oTitleField.attachEventOnce("translationPopoverOpened",function () {
														...
														assert.equal(aHeaderItems1[1].getText(), that.oEditor._oResourceBundle.getText("EDITOR_FIELD_TRANSLATION_LIST_POPOVER_CURRENTLANGUAGE"), "oTranslationPopover1 Header: Current Language");
														assert.equal(aHeaderItems1[2].getItems()[0].getText(), oLanguage.description, "oTranslationPopover1 Header: English");
														sExpectedValueInPopoverTitle = _oExpectedCardTitleValues["child2-1"]["default"];
														assert.equal(aHeaderItems1[2].getItems()[1].getValue(), sExpectedValueInPopoverTitle, "oTranslationPopover1 Header: Title Value");
														assert.equal(aHeaderItems1[2].getItems()[1].getEditable(), false, "oTranslationPopover1 Header: Editable false");
														assert.equal(aHeaderItems1[3].getText(), that.oEditor._oResourceBundle.getText("EDITOR_FIELD_TRANSLATION_LIST_POPOVER_OTHERLANGUAGES"), "oTranslationPopover1 Header: Other Languages");
														assert.ok(oTranslationPopover1.getContent()[0].isA("sap.m.List"), "oTranslationPopover1 Content: List");
														...
														for (var i = 0; i < oLanguageItems1.length; i++) {
															var sLanguage = oLanguageItems1[i].getCustomData()[0].getKey();
															var sExpectedValueInPopoveItem = _oExpectedCardTitleValues["child2-1"][sLanguage] || _oExpectedCardTitleValues["child2-1"]["defaultOri_in_trans"];
															var sCurrentValue = oLanguageItems1[i].getContent()[0].getItems()[1].getValue();
															assert.equal(sCurrentValue, sExpectedValueInPopoveItem, "oTranslationPopover1 Content: item " + i + " " + sLanguage + ", current: " + sCurrentValue + ", expected: " + sExpectedValueInPopoveItem);
														}
														oCancelButton1 = oTranslationPopover1.getFooter().getContent()[2];
