...
sap.ui.define([
	...
	QUnit.module("Check the translation mode", {
		...
		_aCoreLanguages.forEach(function(oCoreLanguage) {
			...
			var sString4OriValue = _oExpectedValues["string4"][sCoreLanguageKey] || _oExpectedValues["string4"]["default"];
			...
			_aEditorLanguages.forEach(function(oEditorLanguage) {
				...
				var sString1OriValue = sEditorLanguageKey === sCoreLanguageKey ? _oExpectedValues["string1"]["default"] : _oExpectedValues["string1"]["defaultOri_in_trans"];
