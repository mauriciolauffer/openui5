sap.ui.define([
	...
	"sap/m/library"
], function (Controller, Element, Dialog, Button, Label, Input, NavigationListItem, mobileLibrary) {
	"use strict";

	const ButtonType = mobileLibrary.ButtonType;

	return Controller.extend("sap.tnt.sample.SideNavigationWrapping.C", {
