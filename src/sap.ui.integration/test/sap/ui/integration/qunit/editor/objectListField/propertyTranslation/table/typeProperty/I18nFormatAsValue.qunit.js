											...
											EditorQunitUtils.wait().then(function () {
												...
												EditorQunitUtils.wait().then(function () {
													...
													EditorQunitUtils.wait().then(function () {
														...
														EditorQunitUtils.wait().then(function () {
															oNewObject = JSON.parse(oTextArea.getValue());
															assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oNewObject), Object.assign(deepClone(oDefaultNewObject, 500), {"text": "{i18n>string2}"})), "SimpleForm: Value updated");
