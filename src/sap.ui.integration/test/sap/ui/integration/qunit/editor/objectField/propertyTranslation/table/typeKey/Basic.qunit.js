				...
				EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(that.oEditor).then(function () {
						...
						EditorQunitUtils.wait().then(function () {
							...
							assert.ok(deepEqual(EditorQunitUtils.cleanUUID(oTextArea.getValue()), oDefaultNewObject), "SimpleForm field textArea: Has Default value");
							...
							assert.equal(oFormField.getValue(), "string value 1", "SimpleForm field 1: Has new value");
							assert.ok(deepEqual(EditorQunitUtils.cleanUUID(oTextArea.getValue()), Object.assign(deepClone(oDefaultNewObject, 500), {"key": "string value 1"})), "SimpleForm: Value updated");
							assert.ok(!oFormField.getShowValueHelp(), "SimpleForm field 1: ShowValueHelp false");
							assert.ok(!oFormField._oValueHelpIcon, "SimpleForm field 1: Value help icon not exist");
							...
							EditorQunitUtils.wait().then(function () {
								...
								assert.ok(deepEqual(EditorQunitUtils.cleanUUID(oTextArea.getValue()), Object.assign(deepClone(oDefaultNewObject, 500), {"key": "{i18n>string1}"})), "SimpleForm: Value updated");
								...
								EditorQunitUtils.wait().then(function () {
									...
									assert.ok(deepEqual(EditorQunitUtils.cleanUUID(oTextArea.getValue()), Object.assign(deepClone(oDefaultNewObject, 500), {"key": "string1"})), "SimpleForm: Value updated");
									assert.ok(!oFormField.getShowValueHelp(), "SimpleForm field 1: ShowValueHelp false");
									assert.ok(oFormField._oValueHelpIcon, "SimpleForm field 1: Value help icon exist");
				...
				EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(that.oEditor).then(function () {
						...
						EditorQunitUtils.wait().then(function () {
							...
							assert.ok(deepEqual(EditorQunitUtils.cleanUUID(oNewObject), oDefaultNewObject), "SimpleForm field textArea: Has Default value");
							var oFormLabel = oContents[0];
							var oFormField = oContents[1];
							assert.equal(oFormLabel.getText(), "translated key en", "SimpleForm label 1: Has label text");
							assert.ok(oFormLabel.getVisible(), "SimpleForm label 1: Visible");
							...
							EditorQunitUtils.wait().then(function () {
								...
								assert.ok(deepEqual(EditorQunitUtils.cleanUUID(oNewObject), Object.assign(deepClone(oDefaultNewObject, 500), {"key": "{i18n>string1}"})), "SimpleForm: Value updated");
								assert.ok(oFormField.getShowValueHelp(), "SimpleForm field 1: ShowValueHelp true");
								var oValueHelpIcon1 = oFormField._oValueHelpIcon;
								assert.ok(oValueHelpIcon1, "SimpleForm field 1: Value help icon exist");
								assert.ok(oValueHelpIcon1.getVisible(), "SimpleForm field 1: Value help icon visible");
									...
									EditorQunitUtils.wait().then(function () {
										...
										EditorQunitUtils.wait().then(function () {
											...
											EditorQunitUtils.wait().then(function () {
												...
												EditorQunitUtils.wait().then(function () {
													oNewObject = JSON.parse(oTextArea.getValue());
													assert.ok(deepEqual(EditorQunitUtils.cleanUUID(oNewObject), Object.assign(deepClone(oDefaultNewObject, 500), {"key": "string value 2"})), "SimpleForm: Value updated");
									...
									EditorQunitUtils.wait().then(function () {
										...
										EditorQunitUtils.wait().then(function () {
											...
											EditorQunitUtils.wait().then(function () {
												...
												EditorQunitUtils.wait().then(function () {
													oNewObject = JSON.parse(oTextArea.getValue());
													assert.ok(deepEqual(EditorQunitUtils.cleanUUID(oNewObject), Object.assign(deepClone(oDefaultNewObject, 500), {"key": "{i18n>string2}"})), "SimpleForm: Value updated");
