			...
			return new Promise(function (resolve, reject) {
				EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(this.oEditor).then(function () {
						...
						assert.ok(deepEqual(EditorQunitUtils.cleanUUID(oField1._getCurrentProperty("value")), {"text": "text value 1"}), "Field 1: DT Value updated");
						...
						oField1.attachEventOnce("translationPopoverOpened", function () {
							...
							EditorQunitUtils.wait().then(function () {
								...
								EditorQunitUtils.wait().then(function () {
									...
									assert.ok(deepEqual(EditorQunitUtils.cleanUUID(oField1._getCurrentProperty("value")), {"text": "text value 1"}), "Field 1: DT Value");
			...
			return new Promise(function (resolve, reject) {
				EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(this.oEditor).then(function () {
						...
						assert.ok(oDeleteButton.getEnabled(), "SimpleForm: Delete button is enabled");
						assert.ok(deepEqual(EditorQunitUtils.cleanUUID(oField1._getCurrentProperty("value")), {"text": "string value 1"}), "Field 1: DT Value updated");
						...
						oField1.attachEventOnce("translationPopoverOpened", function () {
							...
							EditorQunitUtils.wait().then(function () {
								...
								EditorQunitUtils.wait().then(function () {
									...
									assert.ok(deepEqual(EditorQunitUtils.cleanUUID(oField1._getCurrentProperty("value")), {"text": "string value 1"}), "Field 1: DT Value");
									var sUUID = oField1._getCurrentProperty("value")._dt._uuid;
									var sTranslationTextOfEN = oField1.getTranslationValueInTexts("en", sUUID, "text");
