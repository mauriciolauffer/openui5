						...
						EditorQunitUtils.isReady(that.oEditor).then(function () {
							...
							oEditButton1.onAfterRendering = function(oEvent) {
								...
								EditorQunitUtils.wait().then(function () {
									...
									assert.equal(oFormField3.getValue(), oValueOfObject1InAdminChange.text, "SimpleForm 1 field 3: Has value");
									...
									EditorQunitUtils.wait(1500).then(function () {
										...
										EditorQunitUtils.wait().then(function () {
											...
											assert.ok(oEditButton2.getEnabled(), "Table toolbar 2: edit button enabled");
											...
											EditorQunitUtils.wait().then(function () {
												...
												assert.equal(oFormField3.getValue(), oValueOfObject2InAdminChange.text, "SimpleForm 2 field 3: Has value");
												...
												EditorQunitUtils.wait().then(function () {
													...
													EditorQunitUtils.wait().then(function () {
														...
														oTextCell1 = oRow1.getCells()[3];
														sTextPropertyValue = _oExpectedValuesOfChangesFromAdmin["objectWithPropertiesDefined3"][sLanguageKey] || _oExpectedValuesOfChangesFromAdmin["objectWithPropertiesDefined3"]["default"];
														assert.equal(oTextCell1.getText(), sTextPropertyValue, "Row 1: text cell value");
														...
														EditorQunitUtils.wait().then(function () {
															...
															assert.equal(oFormField3.getValue(), oValueOfObject3InAdminChange.text, "SimpleForm 3 field 3: Has value");
