sap.ui.define(['sap/f/thirdparty/webcomponents-base', 'sap/f/thirdparty/webcomponents', 'sap/f/thirdparty/webcomponents-fiori', 'sap/f/thirdparty/parameters-bundle.css', 'sap/f/thirdparty/Icons', 'sap/f/thirdparty/AccessibilityTextsHelper', 'sap/f/thirdparty/parameters-bundle.css2', 'sap/f/thirdparty/i18n-defaults', 'sap/f/thirdparty/parameters-bundle.css3', 'sap/f/thirdparty/Title'], (function (webcomponentsBase, webcomponents, webcomponentsFiori, parametersBundle_css$2, Icons, AccessibilityTextsHelper, parametersBundle_css, i18nDefaults, parametersBundle_css$1, Title) { 'use strict';
    ...
    var IllustrationMessageDesign$1 = IllustrationMessageDesign;
    ...
    var IllustrationMessageType$1 = IllustrationMessageType;

    var dialogSvg = `<svg width="160" height="160" viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg" id="sapIllus-Dialog-BeforeSearch">
...
`;
    ...
    var sceneSvg = `<svg width="320" height="240" viewBox="0 0 320 240" fill="none" xmlns="http://www.w3.org/2000/svg" id="sapIllus-Scene-BeforeSearch">
...
`;
    ...
    var spotSvg = `<svg width="128" height="128" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg" id="sapIllus-Spot-BeforeSearch">
...
`;
    ...
    var dotSvg = `<svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg" id="sapIllus-Dot-BeforeSearch">
...
`;
    ...
    let IllustratedMessage = IllustratedMessage_1 = class IllustratedMessage extends webcomponentsBase.b {
        ...
        async onBeforeRendering() {
            ...
            let illustrationData = d(effectiveName);
            ...
            if (illustrationData === undefined) {
                illustrationData = await S(effectiveName);
            }
        ...
        _handleCustomSize() {
            switch (this.design) {
                case IllustrationMessageDesign$1.Base:
                    this.media = IllustratedMessage_1.MEDIA.BASE;
                    return;
                case IllustrationMessageDesign$1.Dot:
                    this.media = IllustratedMessage_1.MEDIA.DOT;
                    return;
                case IllustrationMessageDesign$1.Spot:
                    this.media = IllustratedMessage_1.MEDIA.SPOT;
                    return;
                case IllustrationMessageDesign$1.Dialog:
                    this.media = IllustratedMessage_1.MEDIA.DIALOG;
                    return;
                case IllustrationMessageDesign$1.ExtraSmall:
                    this.media = IllustratedMessage_1.MEDIA.DOT;
                    return;
                case IllustrationMessageDesign$1.Small:
                    this.media = IllustratedMessage_1.MEDIA.SPOT;
                    return;
                case IllustrationMessageDesign$1.Medium:
                    this.media = IllustratedMessage_1.MEDIA.DIALOG;
                    return;
                default:
        ...
        isValidIllustration(currentIllustration) {
            ...
            return currentIllustration in IllustrationMessageType$1;
        }
    };
    __decorate([
        webcomponentsBase.s()
    ...
    var IllustratedMessage$1 = IllustratedMessage;

    return IllustratedMessage$1;
