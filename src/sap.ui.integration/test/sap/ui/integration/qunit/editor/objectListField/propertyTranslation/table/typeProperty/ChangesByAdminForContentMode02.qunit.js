						...
						EditorQunitUtils.isReady(that.oEditor).then(function () {
							...
							oEditButton1.onAfterRendering = function(oEvent) {
								...
								EditorQunitUtils.wait().then(function () {
									...
									assert.equal(oFormField1.getValue(), oObject1InAdminChange.text, "SimpleForm 1 field 3: Has value");
									...
									EditorQunitUtils.wait(1500).then(function () {
										...
										EditorQunitUtils.wait().then(function () {
											oField1._oObjectDetailsPopover.attachEventOnce("afterOpen", function(oEvent) {
												...
												assert.equal(oFormField2.getValue(), oObject2InAdminChange.text, "SimpleForm 2 field 3: Has value");
												...
												EditorQunitUtils.wait().then(function () {
													...
													EditorQunitUtils.wait().then(function () {
														oField1._oObjectDetailsPopover.attachEventOnce("afterOpen", function(oEvent) {
															...
															assert.equal(oFormField3.getValue(), oObject3InAdminChange.text, "SimpleForm 3 field 3: Has value");
															...
															EditorQunitUtils.wait().then(function () {
																...
																for (var i = 0; i < oLanguageItems3.length; i++) {
																	...
																	if (oCustomData && oCustomData.length > 0) {
																		var sLanguage = oCustomData[0].getKey();
																		var sExpectedValue = _oExpectedValuesOfChangesFromAdmin["object3"][sLanguage] || _oExpectedValuesOfChangesFromAdmin["object3"]["default"];
