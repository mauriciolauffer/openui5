											...
											EditorQunitUtils.wait().then(function () {
												...
												EditorQunitUtils.wait().then(function () {
													...
													EditorQunitUtils.wait().then(function () {
														...
														oTextCell1 = oRow1.getCells()[3];
														sTextPropertyValue = _oExpectedValuesOfChangesFromAdminAndContent["objectWithPropertiesDefined3"][sLanguageKey] || _oExpectedValuesOfChangesFromAdminAndContent["objectWithPropertiesDefined3"]["default"];
														assert.equal(oTextCell1.getText(), sTextPropertyValue, "Row 1: text cell value");
