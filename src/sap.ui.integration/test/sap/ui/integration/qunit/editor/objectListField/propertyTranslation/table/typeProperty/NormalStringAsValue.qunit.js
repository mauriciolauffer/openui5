							...
							EditorQunitUtils.wait(1500).then(function () {
								...
								EditorQunitUtils.wait().then(function () {
									...
									EditorQunitUtils.wait().then(function () {
										...
										assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oNewObject), oDefaultNewObject), "SimpleForm: Value not updated");
							...
							EditorQunitUtils.wait(1500).then(function () {
								...
								EditorQunitUtils.wait().then(function () {
									...
									EditorQunitUtils.wait().then(function () {
										...
										var oNewObject = JSON.parse(oTextArea.getValue());
										assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oNewObject), oDefaultNewObject), "SimpleForm: Value updated");
										var sUUID = oNewObject._dt._uuid;
										var sTranslationTextOfEN = oField.getTranslationValueInTexts("en", sUUID, "text");
										assert.ok(!sTranslationTextOfEN, "Texts: no value");
										destroyEditor(that.oEditor);
									...
									EditorQunitUtils.wait().then(function () {
										...
										EditorQunitUtils.wait().then(function () {
											...
											EditorQunitUtils.wait().then(function () {
												...
												assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oNewObject), Object.assign(deepClone(oDefaultNewObject, 500), {"text": "string value 2"})), "SimpleForm: Value updated");
								...
								EditorQunitUtils.wait().then(function () {
									...
									EditorQunitUtils.wait().then(function () {
										...
										EditorQunitUtils.wait().then(function () {
											...
											EditorQunitUtils.wait().then(function () {
												oNewObject = JSON.parse(oTextArea.getValue());
												assert.ok(deepEqual(EditorQunitUtils.cleanUUIDAndPosition(oNewObject), Object.assign(deepClone(oDefaultNewObject, 500), {"text": "{i18n>string1}"})), "SimpleForm: Value updated");
