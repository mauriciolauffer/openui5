sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var BREADCRUMBS_ARIA_LABEL = "Put usmeravanja";
	var BREADCRUMBS_OVERFLOW_ARIA_LABEL = "Više";
	var BREADCRUMBS_CANCEL_BUTTON = "Odustani";
	var FORM_SELECTABLE_AVALIABLE_VALUES = "Dostupne vrednosti";
	...
	var CAROUSEL_NEXT_ARROW_TEXT = "Sledeća stranica";
	...
	var COLOR_PALETTE_DIALOG_TITLE = "Promeni boju";
	...
	var COLORPICKER_TOGGLE_MODE_TOOLTIP = "Promeni način boje";
	...
	var DATETIMEPICKER_POPOVER_ACCESSIBLE_NAME = "Izaberi datum i vreme za {0}";
	...
	var EXPANDABLE_TEXT_SHOW_MORE_POPOVER_ARIA_LABEL = "Pokaži ceo tekst";
	...
	var FILEUPLOADER_INPUT_TOOLTIP = "Svi fajlovi će biti zamenjeni pri svakom prenosu na server";
	var FILEUPLOADER_VALUE_HELP_TOOLTIP = "Pretraži i zameni sve fajlove";
	...
	var MESSAGE_STRIP_SUCCESS = "Traka poruke o uspehu";
	...
	var INPUT_AVALIABLE_VALUES = "Dostupne vrednosti";
	var VALUE_STATE_ERROR_ALREADY_SELECTED = "Ova vrednost je već odabrana.";
	var MULTIINPUT_ROLEDESCRIPTION_TEXT = "Unos višestruke vrednosti";
	...
	var RANGE_SLIDER_START_HANDLE_DESCRIPTION = "Levi regulator";
	...
	var TABCONTAINER_NEXT_ICON_ACC_NAME = "Sledeće";
	...
	var TABCONTAINER_SUBTABS_DESCRIPTION = "Pritisnite strelicu za dole da otvorite meni podstavki";
	...
	var TIMEPICKER_POPOVER_ACCESSIBLE_NAME = "Izaberi vreme za {0}";
	...
	var DATETIME_PICKER_TIME_BUTTON = "Vreme";
	...
	var VALUE_STATE_TYPE_ERROR = "Status vrednosti - Greška";
	var VALUE_STATE_TYPE_WARNING = "Status vrednosti - Upozorenje";
	...
	var VALUE_STATE_SUCCESS = "Unos uspešno validiran";
	var VALUE_STATE_LINK = "Da pomerite fokus na vezu, pritisnite Ctrl+Alt+F8";
	var VALUE_STATE_LINK_MAC = "Da pomerite fokus na vezu, pritisnite Cmd+Option+F8";
	var VALUE_STATE_LINKS = "Da odete na prvu vezu, pritisnite Ctrl+Alt+F8. Da pređete na sledeću vezu, koristite Tab";
	var VALUE_STATE_LINKS_MAC = "Da odete na prvu vezu, pritisnite Cmd+Option+F8. Da pređete na sledeću vezu, koristite Tab";
	...
	var DAY_PICKER_SELECTED_RANGE_END = "{0} poslednji dan raspona";
	var DAY_PICKER_WEEK_NUMBER_TEXT = "Broj nedelje";
	var DAY_PICKER_NON_WORKING_DAY = "Neradni dan";
	var DAY_PICKER_TODAY = "Danas";
	var MONTH_PICKER_DESCRIPTION = "Odabir meseca";
	var YEAR_PICKER_DESCRIPTION = "Odabir godine";
	var YEAR_RANGE_PICKER_DESCRIPTION = "Odabir raspona godine";
	var SLIDER_TOOLTIP_INPUT_DESCRIPTION = "Pritisnite F2 da biste uneli vrednost";
	var SLIDER_TOOLTIP_INPUT_LABEL = "Trenutna vrednost";
	var STEPINPUT_DEC_ICON_TITLE = "Smanji";
	var STEPINPUT_INC_ICON_TITLE = "Povećaj";
	var SPLIT_BUTTON_DESCRIPTION = "Dugme Podeli";
	var SPLIT_BUTTON_KEYBOARD_HINT = "Pritisnite Razmak ili Enter za pokretanje standardne radnje i Alt + Strelica dole ili F4 za pokretanje radnje strelice";
	...
	var DIALOG_HEADER_ARIA_DESCRIBEDBY_RESIZABLE = "Koristite Shift+strelice na tastaturi za promenu veličine";
	var DIALOG_HEADER_ARIA_DESCRIBEDBY_DRAGGABLE = "Koristite strelice na tastaturi za kretanje";
	var DIALOG_HEADER_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE = "Koristite strelice na tastaturi za kretanje, Shift+strelice na tastaturi za promenu veličine";
	var LABEL_COLON = ":";
	var TOOLBAR_OVERFLOW_BUTTON_ARIA_LABEL = "Dodatne opcije";
	var TOOLBAR_POPOVER_AVAILABLE_VALUES = "Dostupne vrednosti";
	...
	var TABLE_NAVIGATION = "Usmeravanje";
	var TABLE_GENERATED_BY_AI = "Generisala veštačka inteligencija";
	...
	var DYNAMIC_DATE_RANGE_TOMORROW_TEXT = "Sutra";
	...
	var DYNAMIC_DATE_RANGE_NAVIGATION_ICON_TOOLTIP = "Usmeri nazad";
	var TABLE_COLUMN_HEADER_ROW = "Red zaglavlja kolone";
	var DYNAMIC_DATE_RANGE_LAST_DAYS_TEXT = "Poslednjih X dana";
	var DYNAMIC_DATE_RANGE_NEXT_DAYS_TEXT = "Sledećih X dana";
	var DYNAMIC_DATE_RANGE_LAST_WEEKS_TEXT = "Poslednjih X nedelja";
	var DYNAMIC_DATE_RANGE_NEXT_WEEKS_TEXT = "Sledećih X nedelja";
	var DYNAMIC_DATE_RANGE_LAST_MONTHS_TEXT = "Poslednjih X meseci";
	var DYNAMIC_DATE_RANGE_NEXT_MONTHS_TEXT = "Sledećih X meseci";
	var DYNAMIC_DATE_RANGE_LAST_QUARTERS_TEXT = "Poslednjih X kvartala";
	var DYNAMIC_DATE_RANGE_NEXT_QUARTERS_TEXT = "Sledećih X kvartala";
	var DYNAMIC_DATE_RANGE_LAST_YEARS_TEXT = "Poslednjih X godina";
	var DYNAMIC_DATE_RANGE_NEXT_YEARS_TEXT = "Sledećih X godina";
	...
	var DYNAMIC_DATE_RANGE_WEEKS_UNIT_TEXT = "Nedelje";
	...
	var DYNAMIC_DATE_RANGE_LAST_COMBINED_TEXT = "Poslednjih X {0} (uključeno)";
	var DYNAMIC_DATE_RANGE_NEXT_COMBINED_TEXT = "Sledećih X {0} (uključeno)";
