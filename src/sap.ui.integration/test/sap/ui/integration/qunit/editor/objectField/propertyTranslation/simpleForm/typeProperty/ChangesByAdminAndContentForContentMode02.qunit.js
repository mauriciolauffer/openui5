				...
				return new Promise(function (resolve, reject) {
					...
					EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
						...
						EditorQunitUtils.isReady(that.oEditor).then(function () {
							...
							assert.equal(oFormField3.getValue(), "string2", "SimpleForm 1 field 3: Has value");
							...
							oField1.attachEventOnce("translationPopoverOpened", function () {
								...
								EditorQunitUtils.wait().then(function () {
									...
									assert.equal(oFormField3.getValue(), "{i18n>string1}", "SimpleForm 2 field 3: Has value");
									...
									oField2.attachEventOnce("translationPopoverOpened", function () {
										...
										EditorQunitUtils.wait().then(function () {
											...
											assert.ok(deepEqual(oField3._getCurrentProperty("value"), oValueOfObject3InContentChange), "Field 3: DT Value from admin");
											...
											assert.equal(oFormField3.getValue(), "string4", "SimpleForm 3 field 3: Has value");
											...
											oField3.attachEventOnce("translationPopoverOpened", function () {
												...
												for (var i = 0; i < oLanguageItems3.length; i++) {
													...
													if (oCustomData && oCustomData.length > 0) {
														var sLanguage = oCustomData[0].getKey();
														var sExpectedValue = _oExpectedValuesOfChangesFromAdminAndContent["objectWithPropertiesDefined3"][sLanguage] || _oExpectedValuesOfChangesFromAdminAndContent["objectWithPropertiesDefined3"]["default"];
