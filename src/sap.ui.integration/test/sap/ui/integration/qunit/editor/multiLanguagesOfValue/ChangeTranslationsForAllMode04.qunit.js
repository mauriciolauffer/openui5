...
sap.ui.define([
	...
	var _oContentChanges = {
		...
		"texts": {
			"fr": {
				"/sap.card/configuration/parameters/stringParameter/value": "String1 FR Content"
			},
			"de": {
				"/sap.card/configuration/parameters/stringParameter/value": "String1 DE Content"
			}
		}
	};
	var _oTranslationChanges = {
		"/sap.card/configuration/parameters/stringParameter/value": "String1 Value Translation",
		":layer": 10,
		":errors": false
	};
	...
	QUnit.module("With Content changes and Translation changes", {
		beforeEach: function () {
			...
			return new Promise(function (resolve, reject) {
				...
				EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(that.oEditor).then(function () {
						...
						assert.equal(oField1.getAggregation("_field").getValue(), "String1 Value Translation", "oField1: String1 Value Translation");
						...
						oField1.attachEventOnce("translationPopoverOpened", function () {
							...
							assert.equal(aHeaderItems1[2].getItems()[1].getValue(), "String1 Value Translation", "oTranslationPopover1 Header: String1 Value Translation");
							...
							for (var i = 0; i < oLanguageItems1.length; i++) {
								...
								if (sLanguage === "fr") {
									sExpectedValue = "String1 FR Content";
								}
								if (sLanguage === "de") {
									sExpectedValue = "String1 DE Content";
								}
	...
	QUnit.module("With Admin changes and Content changes and Translation changes", {
		beforeEach: function () {
			this.oHost = new Host("host");
			this.oContextHost = new ContextHost("contexthost");
		},
