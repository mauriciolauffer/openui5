						...
						EditorQunitUtils.isReady(that.oEditor).then(function () {
							...
							oEditButton1.onAfterRendering = function(oEvent) {
								...
								EditorQunitUtils.wait().then(function () {
									...
									assert.equal(oFormField1.getValue(), oValueOfObject1InAdminChange.key, "SimpleForm 1 field 1: Has value");
									...
									EditorQunitUtils.wait(1500).then(function () {
										...
										EditorQunitUtils.wait().then(function () {
											...
											EditorQunitUtils.wait().then(function () {
												...
												assert.equal(oFormField1.getValue(), oValueOfObject2InAdminChange.key, "SimpleForm 2 field 1: Has value");
												...
												EditorQunitUtils.wait().then(function () {
													...
													var oKeyCell1 = oRow1.getCells()[1];
													assert.equal(oKeyCell1.getText(), "string3", "Row 1: key cell value");
													...
													EditorQunitUtils.wait().then(function () {
														...
														assert.equal(oFormField1.getValue(), oValueOfObject3InAdminChange.key, "SimpleForm 3 field 1: Has value");
