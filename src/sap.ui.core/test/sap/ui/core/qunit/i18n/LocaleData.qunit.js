...
], function(timezones, Log, Formatting, LanguageTag, Localization, CalendarType, CalendarWeekNumbering,
		TimezoneUtils, LoaderExtensions, Configuration, Lib, Locale, LocaleData) {
	"use strict";
