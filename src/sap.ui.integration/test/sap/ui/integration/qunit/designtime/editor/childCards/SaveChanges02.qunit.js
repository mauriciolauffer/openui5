...
sap.ui.define([
	...
	QUnit.module("translation mode", {
		...
		QUnit.test("main editor with change", function (assert) {
			var that = this;
			that.oEditor.setCard({
				baseUrl: sBaseUrl,
				host: "contexthost",
		...
		QUnit.test("child1 with change", function (assert) {
			var that = this;
			that.oEditor.setCard({
				baseUrl: sBaseUrl,
				host: "contexthost",
		...
		QUnit.test("child1-1 with no change", function (assert) {
			var that = this;
			that.oEditor.setCard({
				baseUrl: sBaseUrl,
				host: "contexthost",
		...
		QUnit.test("child1-1 with change", function (assert) {
			var that = this;
			that.oEditor.setCard({
				baseUrl: sBaseUrl,
				host: "contexthost",
		...
		QUnit.test("child1-2 with no change", function (assert) {
			var that = this;
			that.oEditor.setCard({
				baseUrl: sBaseUrl,
				host: "contexthost",
		...
		QUnit.test("child1-2 with change", function (assert) {
			var that = this;
			that.oEditor.setCard({
				baseUrl: sBaseUrl,
				host: "contexthost",
		...
		QUnit.test("child2 with change", function (assert) {
			var that = this;
			that.oEditor.setCard({
				baseUrl: sBaseUrl,
				host: "contexthost",
		...
		QUnit.test("child2-1 with no change", function (assert) {
			var that = this;
			that.oEditor.setCard({
				baseUrl: sBaseUrl,
				host: "contexthost",
							...
							EditorQunitUtils.isReady(that.oEditor).then(function () {
								...
								EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
									...
									EditorQunitUtils.isReady(that.oEditor).then(function () {
										...
										assert.ok(oTitleFieldOri.isA("sap.ui.integration.editor.fields.StringField"), "Title Field Ori: String Field");
										assert.ok(oTitleFieldOri.getAggregation("_field").isA("sap.m.Text"), "Title Field Ori: Control is an Text");
										assert.equal(oTitleFieldOri.getAggregation("_field").getText(), "Child Card Title Child2-1", "Title Field Ori: String Value");
										assert.ok(oTitleField.isA("sap.ui.integration.editor.fields.StringField"), "Title Field: String Field");
										assert.ok(oTitleField.getAggregation("_field").isA("sap.m.Input"), "Title Field: Control is an Input");
		...
		QUnit.test("child2-1 with change", function (assert) {
			var that = this;
			that.oEditor.setCard({
				baseUrl: sBaseUrl,
				host: "contexthost",
			...
			return new Promise(function (resolve, reject) {
				EditorQunitUtils.isFieldReady(that.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(that.oEditor).then(function () {
						...
						assert.equal(oMainNode.text, "Main Card", "Child tree main node text is OK");
